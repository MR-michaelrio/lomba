<?php
include('koneksi.php');
$query = mysqli_query($koneksi,"SELECT * FROM buat_travel");
?>
<html>
<head>
...
<form method="post" action="proses.php" enctype="multipart/form-data">
        <table class=table border=0>
            <tr class=kolom>
                <td>Judul Tour</td>
                <td><input class=wow type="judul" name="judul"/></td>
            </tr>
            <tr>
                <td>Tanggal dan Hari</td>
                <td><input class=wow type="date" name="tanggal"/></td>
            </tr>
            <tr class=kolom>
                <td>Gambar</td>
            ...
            <tr>
                <td>Keterangan</td>
                <td><textarea class=wow name="keterangan"></textarea></td>
            </tr>
            <tr>
                <td></td>
